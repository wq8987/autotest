...
public class AutoTestByNG {

	// 打开浏览器
	private WebDriver driver = null;

	@DataProvider(name = "autoTestParam")
	public static String[][] primeNumbers() {
		return new String[][] { { "wq8987", "wq89871684" } };
	}
	...
	@Test(groups = { "login" }, dataProvider = "autoTestParam")
	...
	@Test(groups = { "buy" }, dependsOnGroups = { "login" }, dependsOnMethods={"login"})
	public void buy() {
	...
	@Test(groups = { "loginout" },dependsOnGroups={"buy"},dependsOnMethods={"buy"})
	public void loginout() {
		System.out.println("loginout-start");
		//退出登陆
